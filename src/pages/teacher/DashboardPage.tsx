...
export default function TeacherDashboardPage() {
  const courses = [
    { id: 1, name: 'Информатика', students: '52 студентов' },
    { id: 2, name: 'Базы данных', students: '52 студентов' },
    { id: 3, name: 'Алгоритмы', students: '52 студентов' },
    { id: 4, name: 'Физра', students: '52 студентов' },
  ]
        ...
        {courses.map((course) => (
          ...
          >
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-xs text-zinc-400">{course.students}</span>
            </div>
